...
function extend( a, b ) {
    ...
    var oDemo2=getByClass(document,'demo-2')[0];
	...
	grid3D.prototype._init = function() {
		...
		// loading indicator
		this.loader = this.contentEl.querySelector( 'span.loading1' );
	...
	grid3D.prototype._showContent = function( pos ) {
		...
		var self = this,
			loadContent = function() {
				...
				classie.addClass( oDemo2, 'noscroll' );
	...
	grid3D.prototype._hideContent = function() {
		...
		setTimeout( function() { classie.removeClass( oDemo2, 'noscroll' ); }, 25 );
